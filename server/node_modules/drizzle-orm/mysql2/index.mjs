import 'mysql2';
import { e as entityKind, f as fillPlaceholders, m as mapResultRow, s as sql, D as DrizzleError, a as extractTablesRelationalConfig, c as createTableRelationsHelpers } from '../alias-a0c6a0a1.mjs';
import { NoopLogger, DefaultLogger } from '../index.mjs';
import { P as PreparedQuery, M as MySqlSession, a as MySqlTransaction, b as MySqlDatabase, c as MySqlDialect } from '../view-3fdec7de.mjs';
...
function drizzle(client, config = {}) {
    ...
    if (config.schema) {
        if (config.mode === undefined) {
            throw new DrizzleError('You need to specify "mode": "planetscale" or "default" when providing a schema. Read more: https://orm.drizzle.team/docs/rqb#modes');
        }
