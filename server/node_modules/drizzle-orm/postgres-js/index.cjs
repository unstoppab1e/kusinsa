...
class PostgresJsPreparedQuery extends index.PreparedQuery {
    ...
    async execute(placeholderValues = {}) {
        return index.tracer.startActiveSpan('drizzle.execute', async (span) => {
            ...
            if (!fields && !customResultMapper) {
                return index.tracer.startActiveSpan('drizzle.driver.execute', () => {
                    return client.unsafe(query, params);
                });
            }
            const rows = await index.tracer.startActiveSpan('drizzle.driver.execute', () => {
                span?.setAttributes({
